...
import com.example.moneymanagement.presentation.view.activity.addnew.AddNewViewModel
...
class AddNewLoanFragment :
    ...
    override fun bindView() {
        ...
        if (editingTrans != null && editingTrans.type == "loan") {
    ...
    fun senDataLoan() {
        val getMoney = binding.edtSetMoney.text.toString().replace(".", "")
