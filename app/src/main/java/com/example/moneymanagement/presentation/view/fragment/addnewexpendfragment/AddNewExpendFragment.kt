package com.example.moneymanagement.presentation.view.fragment.addnewexpendfragment
...
import com.example.moneymanagement.presentation.view.activity.addnewactivity.AddNewViewModel
...
class AddNewExpendFragment :
    ...
    override fun initializeEvents() {
        ...
        binding.edtSetMoney.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                try {
                    ...
                    binding.edtSetMoney.setSelection(binding.edtSetMoney.text.length)
    ...
    fun sendDataExpend() {
        ...
        val setMoney = binding.edtSetMoney.text.toString().replace(".", "")
