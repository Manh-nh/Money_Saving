package com.example.moneymanagement.presentation.view.fragment.expendstaticfragment
...
class ExpendStaticFragment :
    ...
    private fun updatePieChart(entries: List<PieEntry>) {
        ...
        pieChart.isHighlightPerTapEnabled = false // Disable phình to khi ấn
        ...
        entries.forEach { entry ->
            ...
            if (icon != null) {
                // Create a resized bitmap to bypass MPAndroidChart's intrinsic size override
        ...
        // Move values (and icons) inside the slices
